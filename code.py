...
genai.configure(api_key="AIzaSyDCf6aYDvHk0aViC_uP-N_OgaJdC2sUfAI")

# Define the system prompt
sys_prompt = """You are a helpful AI Code Reviewer for any coding language.
                Users will submit their any language  code for review and receive feedback on potential bugs along with suggestions for fixes.
...
st.markdown("<small>Powered by Deepika</small>", unsafe_allow_html=True)  # Subline with small fonts
st.subheader("Enter your  code for review:")

# Code input area
user_code = st.text_area("Enter you  code here....", height=200)
